...
public class Engine extends NgnEngine{
	...
	private static final String CONTENT_TITLE = "Galagala";
...
//        Intent intent = new Intent(GalagalaDroid.getContext(), MessageActivity.class);
...
//                intent.putExtra("action", MessageActivity.ACTION_SHOW_CONTSHARE_SCREEN);
...
//        		intent.putExtra("action", MessageActivity.ACTION_SHOW_AVSCREEN);
        		break;
...
//        		intent.putExtra("action", MessageActivity.ACTION_SHOW_CHAT_SCREEN);
        		break;
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(GalagalaDroid.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(GalagalaDroid.getContext(), CONTENT_TITLE, tickerText, contentIntent);
	...
	public void SMSNotif() {
		NotificationCompat.Builder builder = new NotificationCompat.Builder(GalagalaDroid.getContext());
		Uri uri= RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
		builder.setSound(uri);
		mNotifManager.notify(NOTIF_SMS_ID, builder.build());
	}

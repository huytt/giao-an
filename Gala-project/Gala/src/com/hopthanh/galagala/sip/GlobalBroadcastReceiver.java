...
//				return;
//			}
//			final boolean intercept = SipSingleton.getInstance().getEngine().getConfigurationService().getBoolean(NgnConfigurationEntry.GENERAL_INTERCEPT_OUTGOING_CALLS, NgnConfigurationEntry.DEFAULT_GENERAL_INTERCEPT_OUTGOING_CALLS);
//			if (intercept) {

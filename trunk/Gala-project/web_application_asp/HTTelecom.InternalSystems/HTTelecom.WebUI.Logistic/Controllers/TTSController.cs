...
namespace HTTelecom.WebUI.Logistic.Controllers
{
    public class TTSController : Controller
    {
        ...
        [SessionLoginFilter]
        //public ActionResult LogisticManager(int? page, int? filter, int? tag, string q)
        //{
        //    if (q == null) q = "";
        //    ViewBag.page = page;
        //    if (filter == null) filter = 0;
        ...
        public ActionResult GetNotification(int? page, int? filter, int? tag, string q)
        {
            ...
            if (acc.GroupAccounts.Where(n => n.GroupId == WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_DELIVERY).ToList().Count > 0)
            {
                List_Allow_Edit = new List<Tuple<string, string, string, Nullable<bool>>>()
            { 
            new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REQUEST,true)
            };
            }

            if (acc.GroupAccounts.Where(n => n.GroupId == WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_WAREHOUSE).ToList().Count > 0)
            {

                List_Allow_Edit = new List<Tuple<string, string, string, Nullable<bool>>>() 
            { 
            new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_MANAGER,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_MANAGER,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_MANAGER,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_2,WebAppConstant.SDC_REJECT,false)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_2,WebAppConstant.SDC_REJECT,false)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_2,WebAppConstant.SDC_REJECT,false)
            };
            }

            if (acc.GroupAccounts.Where(n => n.GroupId == WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGER).ToList().Count > 0)
            {

                List_Allow_Edit = new List<Tuple<string, string, string, Nullable<bool>>>() 
            { 
            new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REQUEST,true)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REJECT,false)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REJECT,false)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,WebAppConstant.SDC_REJECT,false)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_ONLINE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REJECT,null)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_POST_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REJECT,null)
            ,new Tuple<string,string,string,bool?>(WebAppConstant.COF_PRE_PAY,WebAppConstant.GROUP_SALE_GALAGALA_ACCOUNTANT_STAFF,WebAppConstant.SDC_REJECT,null)
            };
            }
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGER)]
        public ActionResult LogisticManager(int? page, int? filter, int? tag, string q)
        {
            #region filter
            if (q == null) q = "";
            ...
            var ListDirection_ALLOW = _TaskDirectionRepository.GetListPermissionEdit(List_Allow_Edit);
            lst = _MainRecordRepository.GetByLogistic(ListDirection_ALLOW, acc.AccountId);
        ...
        #region old
        //public ActionResult LogisticManagerEdit(long id)
        //{
        //    #region load
        //    MainRecord main = new MainRecord();
        //    this.GetList_TaskFormDropDownList(-1, false);
        ...
        //    ViewBag.realOnly = false;
        //    var _Order = _OrderRepository.GetByCode(main.FormId);
        //    if (_Order == null) { return RedirectToAction("LogisticManager"); }
        //    var _taskFormCode = _Order.PaymentTypeCode == "PTC-1" ? "COF-1" : _Order.PaymentTypeCode == "PTC-2" ? "COF-2" : "COF-3";
        //    #region admin
        //    var lstTaskDirection = new List<TaskDirection>();
        //    foreach (var item in lstOrderQueue)
        ...
        //        lst.Add(item.TaskDirectionId);
        //    if (main.TaskDirectionId != null && main.TaskDirectionId != 0 && lst.Contains(Convert.ToInt64(main.TaskDirectionId)) == false)
        //        return RedirectToAction("LogisticManager");
        //    if (main.HoldByManagerId == null)
        //        _iMainRecordService.EditHoldManager(acc.AccountId, main.MainRecordId);
        //    if (main.TaskDirectionId == null)
        //        _iMainRecordService.EditTaskDirection(_TaskDirectionRepository.GetByIsValidAndOrderQuere(_taskFormCode, null, OrderQueue).TaskDirectionId, main.MainRecordId);
        ...
        public ActionResult LogisticManagerEdit(long id)
        {
            ...
            #region load Data
            var _Order = _OrderRepository.GetByCode(main.FormId);
            if (_Order == null) { return RedirectToAction("LogisticManagerEdit"); }
            var SubRecords = _iSubRecordService.GetList_SubRecordByMainRecordId(id).ToList();
            var SubList = CastList_SubRecordFull(SubRecords.ToList());
            ViewBag.SubList = SubList;
            ViewBag.TaskFormString = _TaskFormRepository.GetByCode(main.TaskFormCode).TaskFormName;
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGER), HttpPost]
        public ActionResult LogisticManagerEdit(FormCollection data)
        {
            Account acc = (Account)HttpContext.Session["Account"];
            ...
            if (statusDirectionCode.Equals(WebAppConstant.SDC_REJECT) || statusDirectionCode.Equals(WebAppConstant.SDC_REQUEST))
            {
                ...
                SubRecordJson jsonSub = new SubRecordJson(acc.AccountId.ToString(), statusDirectionCode, "", lst.Count.ToString(), data["DescriptionSub"].ToString(), DateTime.Now.ToString(), SubLast.DateHandIn, mainRecord.MainRecordId.ToString());
                lst.Add(jsonSub);
                ...
                mainRecord.TaskDirectionId = _TaskDirectionRepository.GetBy(
                    ...
                    WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_MANAGER,
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_WAREHOUSE)]
        public ActionResult LogisticManageWarehouse(int? page, int? filter, int? tag, string q)
        {
            #region filter
            if (q == null) q = "";
            ViewBag.page = page;
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_WAREHOUSE)]
        public ActionResult LogisticManageWarehouseEdit(long id)
        {
            #region load
            MainRecord main = new MainRecord();
            IStatusDirectionRepository _iStatusDirectionService = new StatusDirectionRepository();
            ...
            #region check eror
            if (ListDirection_ALLOW.Where(n => n.TaskDirectionId == main.TaskDirectionId).ToList().Count == 0)
                return RedirectToAction("LogisticManageWarehouse");
            #endregion

            if (main.HoldByStaffId == null)
                _iMainRecordService.EditHoldStaff(acc.AccountId, main.MainRecordId);
            else
                if (acc == null || main.HoldByStaffId != acc.AccountId)
                {
                    SetMessage("Access deny!", "");
            ...
            #region load Data
            var _Order = _OrderRepository.GetByCode(main.FormId);
            if (_Order == null) { return RedirectToAction("LogisticManageWarehouseEdit"); }
            var SubRecords = _iSubRecordService.GetList_SubRecordByMainRecordId(id).ToList();
            var SubList = CastList_SubRecordFull(SubRecords.ToList());
            ViewBag.SubList = SubList;
            ViewBag.TaskFormString = _TaskFormRepository.GetByCode(main.TaskFormCode).TaskFormName;
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_WAREHOUSE), HttpPost]
        public ActionResult LogisticManageWarehouseEdit(FormCollection data)
        {
            Account acc = (Account)HttpContext.Session["Account"];
            var statusDirectionCode = data["StatusDirectionCode"].ToString();
            var mainRecordId = Convert.ToInt64(data["MainRecordId"].ToString());
            ...
            if (statusDirectionCode.Equals(WebAppConstant.SDC_REJECT) || statusDirectionCode.Equals(WebAppConstant.SDC_REQUEST))
            {
                ...
                mainRecord.TaskDirectionId = _TaskDirectionRepository.GetBy(
                    mainRecord.TaskFormCode,
                    WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_1,
                    statusDirectionCode).TaskDirectionId;
                mainRecord.HoldByStaffId = null;
                _MainRecordRepository.Edit(mainRecord);
                #endregion
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_DELIVERY)]
        public ActionResult LogisticManageDelivery(int? page, int? filter, int? tag, string q)
        {
            #region filter
            if (q == null) q = "";
            ViewBag.page = page;
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_DELIVERY)]
        public ActionResult LogisticManageDeliveryEdit(long id)
        {
            #region load
            MainRecord main = new MainRecord();
            IStatusDirectionRepository _iStatusDirectionService = new StatusDirectionRepository();
            ...
            #region check eror
            if (ListDirection_ALLOW.Where(n => n.TaskDirectionId == main.TaskDirectionId).ToList().Count == 0)
                return RedirectToAction("LogisticManageDelivery");
            #endregion
            ...
            #region load Data
            var _Order = _OrderRepository.GetByCode(main.FormId);
            if (_Order == null) { return RedirectToAction("LogisticManageDeliveryEdit"); }
            var SubRecords = _iSubRecordService.GetList_SubRecordByMainRecordId(id).ToList();
            var SubList = CastList_SubRecordFull(SubRecords.ToList());
            ViewBag.SubList = SubList;
            ViewBag.TaskFormString = _TaskFormRepository.GetByCode(main.TaskFormCode).TaskFormName;
        ...
        [PermissionFilter(Permission_GroupId = WebAppConstant.PERMISSION_GROUP_LOGISTIC_MANAGE_DELIVERY), HttpPost]
        public ActionResult LogisticManageDeliveryEdit(FormCollection data)
        {
            Account acc = (Account)HttpContext.Session["Account"];
            var statusDirectionCode = data["StatusDirectionCode"].ToString();
            var mainRecordId = Convert.ToInt64(data["MainRecordId"].ToString());
            ...
            if (statusDirectionCode.Equals(WebAppConstant.SDC_REJECT) || statusDirectionCode.Equals(WebAppConstant.SDC_REQUEST))
            {
                ...
                #region Check Order Online vs PrePay pải nhận dc tiền
                OrderRepository _OrderRepository = new OrderRepository();
                var order = _OrderRepository.GetByCode(mainRecord.FormId);
                if (statusDirectionCode.Equals(WebAppConstant.SDC_REQUEST) && mainRecord.TaskFormCode == WebAppConstant.COF_POST_PAY)
                {
                    _OrderRepository.UpdatePayment(order.OrderId, true);
                }

                //if( statusDirectionCode.Equals(WebAppConstant.SDC_ACCEPT))
                ...
                mainRecord.TaskDirectionId = _TaskDirectionRepository.GetBy(
                    mainRecord.TaskFormCode,
                    WebAppConstant.GROUP_SALE_GALAGALA_LOGISTIC_STAFF_2,
                    statusDirectionCode).TaskDirectionId;
                mainRecord.HoldByStaffId = null;
                _MainRecordRepository.Edit(mainRecord);
                #endregion
        ...
        [SessionLoginFilter]
        public ActionResult LogisticEmployee(int? page, int? filter, int? tag, string q)
        {
            if (q == null) q = "";
            ViewBag.page = page;
            if (filter == null) filter = 0;
        ...
        [SessionLoginFilter]
        public ActionResult LogisticEmployeeEdit(long id)
        {
            #region load
            MainRecord main = new MainRecord();
            this.GetList_TaskFormDropDownList(-1, false);
            ...
            //ViewBag.realOnly = false;
            //var _Order = _OrderRepository.GetByCode(main.FormId);
            //if (_Order == null) { return RedirectToAction("LogisticEmployee"); }
            //var _taskFormCode = _Order.PaymentTypeCode == "PTC-1" ? "COF-1" : _Order.PaymentTypeCode == "PTC-2" ? "COF-2" : "COF-3";
            //#region user
            //if (main.TaskDirectionId != null && main.TaskDirectionId != 0 && TaskDirection != null && TaskDirection.OrderQueue != OrderQueue)
            //    return RedirectToAction("LogisticEmployee");
            //if (main.StatusDirectionCode.ToUpper() != "SDC6")
            //{
            //    if ((new List<string>() { "SDC7", "SDC8", "SDC9" }).Contains(main.StatusDirectionCode) == true && (main.HoldByStaffId == null || acc.AccountId == main.HoldByStaffId))
            //    { }
            ...
            //        {
            //            SetMessage("Access deny!", "");
            //            return RedirectToAction("LogisticEmployee", "TTS");
            //        }
            //    ViewBag.ListStatusDirection = new SelectList(((List<StatusDirection>)ViewBag.list_StatusDirection).Where(n => (new List<string>() { "SDC8", "SDC9" }).Contains(n.StatusDirectionCode)).ToList(), "StatusDirectionId", "StatusDirectionName");
            //}
            //#endregion

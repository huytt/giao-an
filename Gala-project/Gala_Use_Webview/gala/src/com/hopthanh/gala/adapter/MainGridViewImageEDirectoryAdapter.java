...
public class MainGridViewImageEDirectoryAdapter extends BaseAdapter {

	private Activity _activity;
	private ArrayList<String> _imagePaths = new ArrayList<String>();
	private int imageWidth;

	public MainGridViewImageEDirectoryAdapter(Activity activity, ArrayList<String> filePaths,
			int imageWidth) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			viewLayout = inflater.inflate(R.layout.main_layout_slide_non_scrollable_gridview_edirectory_item_detail, parent, false);
...
//	        .into(imageView);
			...
			viewHolder.imgStore = (ImageView) viewLayout.findViewById(R.id.imgIcon);

...
namespace HTTelecom.Domain.Core.ExClass
{
    public class WebAppConstant
    {
        ...
        public static readonly List<long?> LOGISTIC_DEPARTMENT = new List<long?> { 6, 7, 8 };
        #region Deparment
        //JQCOF-1-D500
        //JQCOF-2-D500
        //JQCOF-3-D500
        ...
        public const long PERMISSION_GROUP_LOGISTIC_MANAGER = 6;
        public const long PERMISSION_GROUP_LOGISTIC_MANAGE_WAREHOUSE = 7;
        public const long PERMISSION_GROUP_LOGISTIC_MANAGE_DELIVERY = 8;
